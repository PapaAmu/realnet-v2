...
import WebsiteDevelopment from "./Pages/WebDevelopment";
    ...
    <HelmetProvider context={helmetContext}>
      <BrowserRouter>
        ...
        <SEO 
          ...
          canonicalUrl={typeof window !== 'undefined' ? window.location.href : 'https://realnet-web.co.za'}
          ogType="website"
          twitterCard="summary_large_image"
          keywords={["web development south africa", "mobile apps pretoria", "software development", "hosting services", "website design gauteng", "app developers za"]}
        />
            ...
            element={
              <>
                <SEO 
                  ...
                  ogType="service"
                  keywords={["web development south africa", "website design pretoria", "react development", "custom websites za", "ecommerce development", "wordpress development johannesburg"]}
                />
                <WebsiteDevelopment />
              </>
            }
            ...
            element={
              <>
                <SEO 
                  ...
                  ogType="service"
                  keywords={["mobile app development south africa", "iOS apps pretoria", "Android apps johannesburg", "React Native development", "app developers cape town", "mobile applications za"]}
                />
            ...
            element={
              <>
                <SEO 
                  ...
                  ogType="service"
                  keywords={["software development south africa", "web applications pretoria", "API development", "backend systems", "enterprise software", "custom solutions johannesburg"]}
                />
                <WebSoftware />
              </>
            }
            ...
            element={
              <>
                <SEO 
                  ...
                  ogType="service"
                  keywords={["web hosting south africa", "email hosting pretoria", "domain registration", "cloud hosting za", "vps hosting johannesburg", "business email solutions"]}
                />
                <HostingAndEmail />
              </>
            }
            ...
            element={
              <>
                <SEO 
                  ...
                  ogType="article"
                  keywords={["contact web developers", "quote pretoria", "consultation south africa", "project inquiry", "get started", "free estimate za"]}
                />
                <Contact />
              </>
            }
