        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 id="services-heading" className="text-3xl font-bold text-gray-900 mb-4">
              Our <span className="text-orange-600">Development Services</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive digital solutions tailored for South African businesses of all sizes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Native iOS and Android applications that provide seamless mobile experiences for your customers",
                icon: <FaMobile className="text-blue-500 text-xl" />,
                link: "/features/mobile-app-development"
              },
              {
                title: "E-commerce Solutions",
                description: "Online stores with secure payment integration, inventory management, and marketing tools",
                icon: <FaShoppingCart className="text-green-500 text-xl" />,
                link: "/features/web-development/ecommerce-website-quote"
              },
              {
                title: "Web Hosting & Email",
                description: "Reliable hosting solutions with professional business email and 24/7 technical support",
                icon: <FaCloud className="text-purple-500 text-xl" />,
                link: "/features/hosting-and-mails"
              }
            ].map((service, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="mt-4 space-y-1 text-sm text-gray-500">
              ...
              <p>
                <strong>Serving:</strong> Johannesburg, Pretoria, and surrounding areas
              </p>
            </div>
          </div>
        </div>
