...
const AboutUs = () => {
  ...
  return (
    <>
      <SEO
        title="About REALNET WEB SOLUTIONS | Web Development Company South Africa"
        description="Learn about REALNET WEB SOLUTIONS - a leading web development company in South Africa. We specialize in custom websites, mobile apps, and software solutions for businesses in Johannesburg, Pretoria, and nationwide."
        keywords={[
          "about REALNET",
          ...
          "technology company Pretoria",
          "digital solutions South Africa"
        ]}
        ogImage="/about-us-og.jpg"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          "name": "About REALNET WEB SOLUTIONS",
          "description": "Professional web development company in South Africa specializing in custom websites, mobile apps, and software solutions",
          "url": "https://realnet-web.co.za/about-us",
          "mainEntity": {
            "@type": "Organization",
            ...
            "foundingDate": "2023",
            "foundingLocation": "Midrand, South Africa",
            "numberOfEmployees": "2-10",
            "slogan": "Creating Digital Experiences That Drive Growth",
            "knowsAbout": [
              "Web Development",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              ...
              <div>
                ...
                <div className="text-gray-600 space-y-2" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                  <p itemProp="streetAddress">Matsau Street, Ivory Park</p>
                  <p>
