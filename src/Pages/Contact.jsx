...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Our Web Development Team | REALNET WEB SOLUTIONS South Africa"
        description="Get in touch with our web development experts in Midrand, Gauteng. Contact us for website development, mobile apps, and software solutions. Call +27-64-038-8883 or email lukhele@realnet-web.co.za"
        keywords={[
          "contact web developers South Africa",
          ...
          "get website quote South Africa",
        ...
        structuredData={{
          ...
          "@type": "ContactPage",
          "name": "Contact Our Web Development Team",
          "description": "Get in touch with REALNET WEB SOLUTIONS for professional web development, mobile app development, and software solutions in South Africa",
          "url": "https://realnet-web.co.za/contact-us",
          "mainEntity": {
            "@type": "Organization",
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600" itemProp="telephone">(+27) 64 038-8883</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600" itemProp="email">lukhele@realnet-web.co.za</p>
                    </div>
                  </div>
                </div>
