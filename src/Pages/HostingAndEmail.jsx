...
const HostingAndEmail = () => {
  ...
  const hostingFeatures = [
    {
      ...
      description: "Maximum reliability with our SLA-backed uptime guarantee",
      icon: <FaChartLine className="text-2xl" />
    },
    {
      title: "Free SSL Certificates",
      description: "Secure your site with free SSL certificates for all domains",
      icon: <FaLock className="text-2xl" />
    },
    {
      title: "Daily Backups",
      description: "Automatic daily backups with easy one-click restoration",
      icon: <FaDatabase className="text-2xl" />
    },
    {
      title: "24/7 Expert Support",
      description: "Round-the-clock support from our hosting experts",
    ...
    },
    {
      ...
      description: "Install WordPress, Joomla, and 100+ apps with one click",
  ...
  const emailFeatures = [
    {
      ...
      description: "you@yourbusiness.com - No more generic Gmail addresses",
    ...
    },
    {
      ...
      description: "Ample storage space for all your business communications",
      icon: <FaDatabase className="text-2xl" />
    },
    {
    ...
    },
    {
      ...
      description: "Integrated calendar and contacts synchronization",
      icon: <FaSync className="text-2xl" />
    },
    {
      title: "No Ads",
      description: "Professional, ad-free email experience",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Powerful, reliable hosting solutions and professional business email to elevate your online presence and communication.
              </motion.p>
              <motion.div 
              ...
              >
                <motion.button 
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg shadow-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 flex items-center gap-2"
                ...
                <motion.button 
                  className="px-6 py-3 border border-blue-500 text-blue-300 font-semibold rounded-lg shadow-sm hover:bg-blue-500/10 transition-all duration-300 flex items-center gap-2"
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Focus on your business while we handle the technical details of your hosting infrastructure
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ditch generic email addresses and build trust with professional email that matches your domain
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your business needs with our transparent pricing
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">High-performance hosting solutions</p>
              </div>
                ...
                {hostingPlans.map((plan, index) => (
                  ...
                  >
                    <div className="bg-gradient-to-b from-gray-900/70 to-gray-800/70 rounded-2xl p-6 backdrop-blur-sm">
                      ...
                      <motion.button 
                        className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${plan.recommended ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}
                        whileHover={{ y: -2 }}
                        whileTap={{ y: 0 }}
                      >
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Professional business email solutions</p>
              </div>
                ...
                {emailPlans.map((plan, index) => (
                  ...
                  >
                    <div className="bg-gradient-to-b from-gray-900/70 to-gray-800/70 rounded-2xl p-6 backdrop-blur-sm">
                      ...
                      <motion.button 
                        className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${plan.recommended ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white hover:from-cyan-600 hover:to-blue-600' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'}`}
                        whileHover={{ y: -2 }}
                        whileTap={{ y: 0 }}
                      >
                        Get Started <FaArrowRight className="text-sm" />
      ...
      {/* CTA Section */}
      <section className="py-20 lg:py-28 bg-gradient-to-r from-blue-600 to-cyan-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Get enterprise-grade hosting and professional email that builds trust and drives growth for your business.
            </p>
            <motion.div 
            ...
            >
              <motion.button 
                className="px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl shadow-2xl hover:bg-gray-100 transition-all duration-300 flex items-center justify-center gap-2"
              ...
              <motion.button 
                className="px-8 py-4 border border-white text-white font-semibold rounded-xl shadow-lg hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2"
                whileHover={{ y: -3, scale: 1.02 }}
                whileTap={{ y: 0 }}
                variants={fadeIn}
