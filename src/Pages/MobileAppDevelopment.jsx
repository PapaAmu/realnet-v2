        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="mb-6">
                <motion.span 
                  className="px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-500 rounded-full text-sm font-semibold inline-block"
              ...
              >
                We create stunning, high-performance mobile applications that engage users and drive business growth across iOS and Android platforms.
              </motion.p>
              <motion.div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We ensure your app stands out in both major app stores with optimized listings and ratings
            </p>
          </motion.div>
      ...
      <section className="relative py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive mobile app development solutions for startups and enterprises
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A structured approach to transform your idea into a successful mobile application
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We use cutting-edge technologies to build high-performance, scalable mobile applications
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Let's turn your app idea into reality with our expert mobile development team and dominate both app stores.
            </p>
            <motion.div 
