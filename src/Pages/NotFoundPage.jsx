...
const NotFoundPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Page Not Found | 404 Error | REALNET WEB SOLUTIONS"
            ...
            <div className="flex flex-col justify-center">
              ...
              >
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center">
                    ...
                    <Link to="/" className="hover:text-orange-600 transition-colors duration-200">Homepage</Link>
                  </li>
                  <li className="flex items-center">
                    <FaSearch className="text-orange-500 mr-2" />
                    <Link to="/" className="hover:text-orange-600 transition-colors duration-200">Search</Link>
                  </li>
                  <li className="flex items-center">
                    <FaRocket className="text-orange-500 mr-2" />
                    <Link to="/features/web-development" className="hover:text-orange-600 transition-colors duration-200">Our Services</Link>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-400 to-pink-500 text-white font-medium rounded-xl shadow-md hover:shadow-lg transition-all duration-200"
                >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-white border border-gray-300 text-gray-800 font-medium rounded-xl shadow-sm hover:bg-gray-50 transition-colors duration-200"
