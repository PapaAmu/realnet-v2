        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              At REALNET Web Solutions, we are committed to protecting your privacy and ensuring compliance with the Protection of Personal Information Act (POPIA). This page outlines our privacy practices, your rights, and how we handle your personal information.
            </p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We adhere to all eight conditions for lawful processing of personal information as outlined in POPIA.
            </p>
          </motion.div>
          ...
          <div className="space-y-12">
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="space-y-4 text-gray-600">
                <p><strong>Personal Information:</strong> Name, email address, phone number, company information, and other details you provide when contacting us or requesting services.</p>
                ...
                <p><strong>Communication Records:</strong> Records of our correspondence, including emails, phone calls, and meeting notes.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-8 shadow-md">
              ...
              <ul className="space-y-3 text-gray-600">
                <li>• To provide and deliver our web development, mobile app development, and hosting services</li>
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>You can control cookie preferences through our cookie consent banner and your browser settings.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>When personal information is no longer needed, we securely delete or anonymize it.</p>
              </div>
            </motion.div>
