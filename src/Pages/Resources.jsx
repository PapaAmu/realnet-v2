    ...
    <>
      <SEO 
        ...
        structuredData={{
          ...
          "@type": "Blog",
          "name": "REALNET Web Development Resources",
          "description": "Expert insights and guides for web development, mobile apps, and digital marketing in South Africa",
          "url": "https://realnet-web.co.za/resources",
          "publisher": {
            "@type": "Organization",
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        ...
        <RelatedContent currentPage="resources" />
