  ...
  const services = [
    {
      ...
      description: "Websites that look beautiful and function perfectly on all devices, from desktops to smartphones.",
    ...
    },
    {
      ...
      description: "Websites built with search engine optimization in mind to help you rank higher in search results.",
      icon: <FaSearch className="text-3xl" />
    },
    {
      title: "Starter Websites",
      description: "Affordable, professional websites perfect for small businesses and personal brands.",
      icon: <FaRocket className="text-3xl" />
    },
    {
      title: "Performance Optimization",
      description: "Lightning-fast websites with optimized loading times and smooth performance.",
      icon: <FaChartLine className="text-3xl" />
    },
    {
      title: "Maintenance & Support",
      description: "Ongoing updates, security patches, and technical support to keep your website running smoothly.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-10">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1015&q=80')] bg-cover bg-center mix-blend-overlay"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Professional <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-pink-400">Websites</span> That Convert
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                We create stunning, high-performance websites that convert visitors into customers and help your business grow online.
              </p>
            ...
            >
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-1 rounded-2xl shadow-2xl transform rotate-3 border border-orange-500/20">
                <div className="bg-gray-800 rounded-2xl p-4">
                  ...
                  <div className="font-mono text-sm">
                    <div className="text-orange-400">function <span className="text-pink-400">createWebsite</span>() {"{"}</div>
                    <div className="ml-4 text-green-400">// Beautiful, functional websites</div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-gradient-to-br from-orange-500 to-pink-500 p-1 rounded-xl shadow-lg transform -rotate-6 z-10">
                <div className="bg-gray-800 rounded-lg p-2">
                  <FaGlobe className="text-4xl text-orange-300" />
                </div>
              </div>
              ...
              <div className="absolute -top-6 -right-6 bg-gradient-to-br from-pink-500 to-orange-500 p-1 rounded-xl shadow-lg transform rotate-6 z-10">
                <div className="bg-gray-800 rounded-lg p-2">
                  <FaMobile className="text-4xl text-pink-300" />
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-pink-400">Website</span> Services
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive website development solutions for businesses of all sizes.
            </p>
          </motion.div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-gray-800 to-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Website <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-pink-400">Packages</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Affordable pricing options to get your business online quickly and professionally.
            </p>
          </motion.div>
            ...
            {pricingPackages.map((pkg, index) => (
              <motion.div 
                ...
                className={`relative rounded-2xl overflow-hidden ${
                  pkg.popular ? "border-2 border-orange-500 transform scale-105" : "border border-orange-500/20"
                }`}
              >
                {pkg.popular && (
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 h-full">
                  <div className="text-center mb-6">
                    ...
                    <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-pink-400 mb-1">
                      {pkg.price}
                    </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Let's create a stunning website that represents your brand and drives growth for your business.
            </p>
