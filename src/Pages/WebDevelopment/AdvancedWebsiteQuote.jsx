            ...
            {features.map((feature) => (
              ...
              >
                <input
                  ...
                  onChange={() => toggleArrayField('features', feature.id)}
...
// Step 3: Project Details
const ProjectDetailsStep = ({ formData, updateFormData, handleFileUpload, removeAttachment }) => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => updateFormData('contact.companyRole', e.target.value)}
              className="w-full bg-gray-700/50 border border-gray-600 rounded-lg md:rounded-xl px-3 md:px-4 py-2 md:py-3 text-white focus:border-orange-500 focus:outline-none backdrop-blur-sm text-sm md:text-base"
            >
