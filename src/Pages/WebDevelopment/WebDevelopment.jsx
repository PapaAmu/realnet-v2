...
const WebsiteDevelopment = () => {
  ...
  const services = [
    {
      ...
      description:
        "Websites that look beautiful and function perfectly on all devices, from desktops to smartphones.",
    ...
    },
    {
      ...
      description:
        "Affordable, professional websites perfect for small businesses and personal brands.",
      icon: <FaRocket className="text-3xl" />,
    },
    {
      title: "Performance Optimization",
      description:
        "Lightning-fast websites with optimized loading times and smooth performance.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={fadeIn}>
              ...
              <p className="text-xl text-gray-300 mb-8">
                ...
                visitors into customers and help your business grow online.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive website development solutions for businesses of all
              sizes.
            </p>
          </motion.div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 lg:py-28 bg-gradient-to-br from-gray-800 to-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Affordable pricing options to get your business online quickly and
              professionally.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Let's create a stunning website that represents your brand and
