  ...
  return (
    <>
      <SEO
        ...
        description="Professional website development services including responsive design, e-commerce solutions, and custom web applications. Get your business online with REALNET in Johannesburg & Pretoria."
        keywords={[
          "website development",
        ...
        ogImage="/web-development-og.jpg"
        structuredData={{
          ...
          "description": "Professional website development services for South African businesses including responsive design, e-commerce solutions, and custom web applications."
        }}
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="#pricing" aria-label="View our website development pricing packages">
                  ...
                  <a href="/features/web-development/live-projects" aria-label="View our web development portfolio and projects">
              ...
              {pricingPackages.map((pkg, index) => (
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 h-full">
                    ...
                    <a href={pkg.url} aria-label={`Get started with ${pkg.name} package`}>
                      <button
