...
const WebSoftware = () => {
  ...
  return (
    <>
      <SEO
        title="Software Development South Africa | REALNET"
        description="Professional custom web application development, software solutions, and business applications in South Africa. Scalable, secure, and responsive web software development."
        keywords={[
          ...
          "web applications Johannesburg",
          "software developers Pretoria",
          "enterprise web solutions",
          "responsive web applications",
          "cloud software development"
        ]}
        ogImage="/software-development-og.jpg"
        structuredData={{
          ...
          "description": "Professional custom web application development and software solutions for South African businesses",
          "areaServed": "ZA",
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  <Link
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold rounded-lg shadow-lg hover:from-orange-600 hover:to-pink-600 transition-all duration-300 transform hover:-translate-y-1"
                  ...
                  <Link
                    to="/features/web-development/live-projects"
                    className="px-6 py-3 border border-orange-500 text-orange-300 font-semibold rounded-lg shadow-sm hover:bg-orange-500/10 transition-all duration-300"
        ...
        <RelatedContent currentPage="software-development" />
      </div>
    </>
  );
};
