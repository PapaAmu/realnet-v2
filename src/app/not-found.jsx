              ...
              >
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-center">
                    ...
                    <Link href="/" className="hover:text-orange-600 transition-colors duration-200">Search</Link>
                  </li>
                  <li className="flex items-center">
                    <FaRocket className="text-orange-500 mr-2" />
                    <Link href="/features/web-development" className="hover:text-orange-600 transition-colors duration-200">Our Services</Link>
                  </li>
                </ul>
              </motion.div>
